# LinkedIn Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The LinkedIn Trademarks Logo. They published some good guidelines on how to use
their trademarks. However, its provided trademark logo for referencing was a
rasterized PNG image which is very unfeasible when it comes to website
deployment. The preferred version is `.svg` which has non-destructive scale up &
down properties and can be converted into any rasterized images (e.g. `jpeg`,
`webp`, `avif`, etc). Hence, a re-draw is required based on their provided
guidelines.

This project re-draws LinkedIn Trademarks Logo specifically for 1200x1200 size.
...
Please read through LinkedIn's Trademark Engineering Specification
(https://brand.linkedin.com) before editing to avoid any unwanted legal
implications.

While not specified by LinkedIn, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: LinkedIn Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-linkedin-1200x1200
UUID: 5CA847F1-3ACB-4CDE-BC42-0CD7EBC95F35
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-12
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-linkedin-1200x1200
--------------------------------------------------------------------------------
```
...
> [!Caution]
>
> While the images are licensed under CC-BY licenses,
> **YOU ARE STILL OBLIGATED TO COMPLY WITH LINKEDIN TRADEMARK REQUIREMENTS
> (Read: https://brand.linkedin.com)**.
>
...
You're **ONLY ALLOWED to reference WITHOUT ANY REMIXING** to the original
image for your pursue including academic referencing as long as you comply to
the attribution above without any count limitations or any other restrictions.
